...
async def create_event(name, ticket_number_start, nm_prime, nm_deposit, nm_usual, event_date, prices):
    endpoint = 'event/'
    data = {
        'name': name,
        'ticket_number_start': ticket_number_start,
        'nm_prime': nm_prime,
        'nm_usual': nm_usual,
...
async def create_ticket(event, ticket_number, name, surname, gender, ticket_type, date_of_birth, price, educational_program,
                        educational_course, phone_number, promouter_name):
    endpoint = 'ticket/'
